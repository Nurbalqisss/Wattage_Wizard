package com.androidproject.WattageWizard;
...
import com.androidproject.WattageWizard.databinding.ActivityAboutBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.toolbar.shareIconIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String shareText = "https://github.com/Nurbalqisss/Wattage_Wizard";
        ...
        binding.linkToGitHubTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String githubUrl = "https://github.com/Nurbalqisss/Wattage_Wizard";
